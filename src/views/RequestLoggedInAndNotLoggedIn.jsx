...
const RequestLoggedInAndNotLoggedIn = () => {
    ...
    return (
        <>
            <ToastContainer />
            <div className="admin-page white-text-div-simple ">
                {isLoggedIn ? (
                    <>
                        {isAdmin ? (
                    ...
                    <div className="user-panel">
                                ...
                                <p>Vous devez être connecté pour accéder à cette fonction.  </p>
                            </div>
...
export default RequestLoggedInAndNotLoggedIn;
